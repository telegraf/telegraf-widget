...
class TelegrafWidget extends Composer {
  ...
  static sendWidget (widgetId, args) {
    return (ctx) => ctx.widget.render(widgetId, null, args, true)
  }

  static button (widgetId, text, page, args) {
...
class Widget extends Router {
  ...
  button (text, page, args) {
    return TelegrafWidget.button(this.id, text, page, args)
  }
